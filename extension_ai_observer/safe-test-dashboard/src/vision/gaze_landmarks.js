...
// factory-argument destructuring that followed it (lines 35-50). All three are
...
// ⚠ The factory body below (upstream lines 51-593) keeps its original 2-space
...
// >>> ESM PORT
// Upstream closed the factory with `return { … };` + `}));` (lines 594-613).
