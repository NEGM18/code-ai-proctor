...
// ---------------------------------------------------------------------------
// >>> ESM PORT
/* eslint-disable no-unused-vars -- `__poseCalibrationExports` below is retained byte-identical
...
// Upstream lines 268-269 were two `if (typeof module|window …)` lines that
