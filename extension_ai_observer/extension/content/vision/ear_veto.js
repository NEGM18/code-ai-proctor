...
/* global eyeAspectRatio, LANDMARK_CONTRACT */

(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('./gaze_landmarks.js'));
  } else {
    root.__earVeto = factory(root);
    Object.assign(root, root.__earVeto);
  }
}(typeof self !== 'undefined' ? self : this, function (landmarks) {
  ...
  const { eyeAspectRatio, LANDMARK_CONTRACT, analyzeGazeLandmarks } = landmarks;
